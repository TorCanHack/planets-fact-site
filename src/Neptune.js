...
import overviewImg from './starter-code/assets/planet-neptune.svg';
import structureImg from './starter-code/assets/planet-neptune-internal.svg';
import surfaceImg from './starter-code/assets/geology-neptune.png';
import sourceIcon from './starter-code/assets/icon-source.svg'

const neptuneData = Data.filter(info => info.name === "Neptune")
...
const Neptune = () => {
    ...
    return (
        <>
        {neptuneData.map(data => (
            <section key={data.name} className="bg-[url('/src/starter-code/assets/background-stars.svg')] lg:px-52 ">
                <div className="flex flex-row justify-between font-spartans text-9 font-bold px-6 border-b  border-gray-300 md:flex-col md:w-281 md:h-154 md:border-b-0 md:relative md:top-98 md:ml-auto lg:w-350 lg:top-96.5">

                    <button onClick={handleOverview} className={`md:p-4 md:border md:border-gray-300 text-left lg:hover:bg-slate-600 ${overview ? 'border-b-4 border-neptuneTheme h-10 md:bg-neptuneTheme': ''}`} >
                        <span className=" hidden md:inline-block md:mr-4">01</span>
                            OVERVIEW
                    </button>

                    <button onClick={handleStructure} className={`md:p-4 md:border md:border-gray-300 text-left lg:hover:bg-slate-600  ${structure ? 'border-b-4 border-neptuneTheme h-10 md:bg-neptuneTheme': ''}`} > 
                    ...
                    <button onClick={handleSurface} className={`md:p-4 md:border md:border-gray-300 text-left lg:hover:bg-slate-600  ${surface ? 'border-b-4 border-neptuneTheme h-10 md:bg-neptuneTheme': ''}`} >
            ...
            {overview ? (<article className="flex flex-col justify-center items-center"> 
                <img src={overviewImg} alt="earth" className="w-44 h-44 my-20 md:w-72 md:h-72 md:-mt-8 lg:w-450 lg:h-450 lg:mr-96"/> 
                <div className="text-center md:text-left md:w-339 md:h-64 md:mr-auto md:px-6 lg:ml-auto lg:mr-0 lg:relative lg:bottom-96 lg:-mt-56">
                    <h2 className="text-40 font-antonio mb-4 md:text-5xl lg:text-8xl">NEPTUNE</h2> 
            ...
            : structure ? (<article className="flex flex-col justify-center items-center">
                <img src={structureImg} alt="earth" className="w-44 h-44 my-20 md:w-72 md:h-72 md:-mt-8 lg:w-450 lg:h-450 lg:mr-96"/> 
                <div className="text-center md:text-left md:w-339 md:h-64 md:mr-auto md:px-6 lg:ml-auto lg:mr-0 lg:relative lg:bottom-96 lg:-mt-56">
                    <h2 className="text-40 font-antonio mb-4 md:text-5xl lg:text-8xl">NEPTUNE</h2> 
            ...
            : (<article className="flex flex-col justify-center items-center"> 
                <img src={overviewImg} alt="earth" className="w-44 h-44 mt-20 md:w-72 md:h-72 md:-mt-8 lg:w-450 lg:h-450 lg:mr-96"/> 
                <img src={surfaceImg} alt="earth" className="relative bottom-10 w-20 h-20 mb-0 md:w-32 md:h-32 md:bottom-16 lg:w-40 lg:h-40 lg:right-48 lg:bottom-20 lg:-mt-4"/> 
                <div className="text-center md:text-left md:w-339 md:h-64 md:mr-auto md:px-6 md:-mt-12 lg:ml-auto lg:mr-0 lg:relative lg:bottom-96 lg:-mt-72">
                    <h2 className="text-40 font-antonio mb-4 md:text-5xl lg:text-8xl">NEPTUNE</h2> 
            ...
            <article className="px-6 my-4 md:flex md:flex-row md:justify-between  lg:-mt-0">
